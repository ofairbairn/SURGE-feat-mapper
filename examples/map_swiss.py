"""Run the SURGE Mapper ladder on a generated sklearn Swiss roll."""
...
DEFAULT_CONFIG = _REPO / "examples" / "configs" / "map_swiss.yaml"


def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run SURGE Mapper on a generated sklearn Swiss roll."
    )
    parser.add_argument(
        "--config",
        type=Path,
...
def main(argv: list[str] | None = None) -> int:
    ...
    print("Swiss-roll Mapper workflow complete.")
