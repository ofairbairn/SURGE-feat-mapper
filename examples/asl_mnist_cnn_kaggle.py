"""Run SURGE workflow for ASL-MNIST (Kaggle) classification."""
...
DEFAULT_CONFIG = Path("examples/configs/asl_mnist_cnn_kaggle.yaml")


def parse_args() -> argparse.Namespace:
	parser = argparse.ArgumentParser(
		description="Run ASL-MNIST classification using SURGE MNIST CNN adapter."
	)
	parser.add_argument(
		"--config",
		type=Path,
